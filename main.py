...
word_list = [
    "gravity falls", "dipper", "mabel", "stanley", "stanford", "mystery shack",
    "bill cipher", "journal", "gnomes", "gideon", "wendy", "soos", "time baby",
    "blendin", "time travel", "author", "pine tree", "shooting star", "question mark",
    "mindscape", "dimension", "weirdmageddon", "ford", "grappling hook", "uncle stan",
    "portal", "grunkle", "secrets", "cipher wheel", "waddles", "cipher hunt"
]
